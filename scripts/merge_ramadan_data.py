...
def merge_data(sources, output_path):
    series_map = {}
    ...
    for s_id in sorted_ids:
        ...
        # TMDB Enrichment: only if poster is missing or not a TMDB link
        if not s.get("poster") or "tmdb.org" not in s.get("poster"):
    ...
    print(f"Successfully cleaned and merged results to {output_path}")

if __name__ == "__main__":
    sources = [
        '/home/tomito/Desktop/tomito/dist/ramadan_2026_results.json',
        '/home/tomito/Desktop/tomito/dist/ramadan_2026_results_1.json',
        '/home/tomito/Desktop/tomito/dist/ramadan_2026_results_2.json'
    ]
    ...
    merge_data(sources, public_path)
    
    # Sync to dist
    shutil.copy2(public_path, dist_path)
    print(f"Synced to {dist_path}")

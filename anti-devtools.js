 ...
 * 
 * MOBILE (الهاتف):
 * - threshold أعلى بكثير (300px)
 * - تجاهل pinch zoom تلقائياً
 * - تجاهل orientation change
 * - فحص أبطأ (200ms بدل 50ms)
 * - ما يستخدمش console/debugger detection
 * - تأخير بعد resize (300ms)
 * 
 * ============================================
 * 
 * إعدادات الهاتف:
 * ============================================
 * 
 * في HTML ديالك، زيد meta tag:
 * <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=5.0, user-scalable=yes">
 * 
 * هاد شي كيسمح بالتكبير العادي بدون بلوكاج!
 * 
 * ============================================
 */